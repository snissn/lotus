...
//type Op struct {
//	Curr int `codec:"v,omitempty"`
//}
//
//type RaftState int
//
//func (o Op) ApplyTo(state consensus.RaftState) (consensus.RaftState, error) {
//	*(state.(*RaftState)) = RaftState(o.Curr)
//	return state, nil
//}
...
//func (cc *Consensus) SetInt(ctx context.Context, val int) error {
//	o := Op{Curr: val}
//	err := cc.commit(ctx, &o, "SetInt", val)
//	if err != nil {
//		return err
//	}
//	return nil
...
//func (cc *Consensus) Rollback(state state.RaftState) error {
...
//func (rpcHandler *modules.RPCHandler) AddPeer(ctx context.Context, in peer.ID, out *struct{}) error {
//	//ctx, span := trace.StartSpan(ctx, "rpc/consensus/AddPeer")
//	//defer span.End()
//	return rpcHandler.cons.AddPeer(ctx, in)
//}
//
//// LogUnpin runs Consensus.LogUnpin().
//func (rpcHandler *modules.RPCHandler) SetInt(ctx context.Context, in int, out *struct{}) error {
//	//ctx, span := trace.StartSpan(ctx, "rpc/consensus/LogUnpin")
//	//defer span.End()
//	return rpcHandler.cons.SetInt(ctx, in)
//}
